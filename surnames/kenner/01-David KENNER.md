...
layout: default
title: "David Kenner"
permalink: /surnames/kenner/david/
custom_color:
custom_font: 
scroll_top_btn:
  enable: true
...
- Died: Living
- Burial Place:  N/A
- Father: [Jerome Kenner]({{ '/surnames/kenner/jerome' | relative_url }})    `#1, #2, #3, #4`
- Mother: [Annette Bower]({{ '/surnames/bower/annette' | relative_url }})   `#1, #2, #3, #4` 
- WID: 1776518586
...
1. [Daily American Republic 18 June 1964](https://github.com/davidjkenner/FirstFamilies/blob/main/docs/Daily_American_Republic_1964_06_18_6.pdf)
