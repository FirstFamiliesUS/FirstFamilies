...
- Born:  1792  `#3, #4, #5, #6, #7`
- Birth Place:
- Spouse:  Charlotte Cook  `#3, #4, #5, #6, #7`
- Marriage Date:  9 Feb 1814  `#4, #5, #6, #7`  
- Marriage Place
- Died: 1840  `#3, #4, #5, #6, #7`
- Burial Place:  Johnson County, Illinois  `#3, #5, #6, #7`  
- Father:  James Howell  `#3, #4, #5, #6, #7`
- Mother:  Martha Denny  `#3, #4, #5, #6, #7`
- Child:
...
2. [FamilySearch](https://www.familysearch.org/en/tree/pedigree/landscape/LR6S-78B): ID [LZDW-T29](https://www.familysearch.org/en/tree/person/about/LZDW-T29)
3. https://services.dar.org/public/dar_research/search_descendants/?action=list&MyPrimary_Seqn=534436&MyLineageCount=1
4. https://services.dar.org/public/dar_research/search_descendants/?action=list&MyPrimary_Seqn=534435&MyLineageCount=1
